function doOrderFormCalculation() {
    ...
    orderCostPerPage=doNewCalculation(orderForm.urgency.value,orderForm.academic_level.value,orderForm.doctype_x.value,orderForm.order_category.value)*(1-(discount/100));
    if (single == true) {
